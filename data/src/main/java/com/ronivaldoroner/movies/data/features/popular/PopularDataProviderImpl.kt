...
class PopularDataProviderImpl(
    ...
    override suspend fun getPopular(isConnected: Boolean): Response<PopularScreen> {
        return remoteProvider.getPopular()

        //TODO
        //Esse codigo permanecerá comentado até que os problemas de dependencias do Room sejam resolvidas,
        //Ao ativar o KSP está apresentando falha no download da dependencia.
